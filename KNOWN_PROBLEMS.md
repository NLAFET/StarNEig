...
### Known compatibility problems
 ...
 - With some OpenBLAS version, it is necessary to set the `OPENBLAS_NUM_THREADS`
   environmental variable to `1` (`export OPENBLAS_NUM_THREADS=1`).
 - For optimal GPU performance, StarPU version that is newer than 1.3.3 is
   recommended.
